...
if (isset($_POST)) {
    if (isset($_POST["add"]) && $_POST["add"] == "1") {
        ...
        if ($sucursal->add())
            echo "<script>alert('Sucursal agregado Correctamente...');window.location.href = '/admin/comercios/sucursales?comercio=$idComercio'; </script>";
        else
            $error = true;
                ...
                <div class="box" style="    padding-bottom: 2.5em; padding-top: 2.5em;">
                    <?php if (isset($comercio) && isset($comercio->nombre)) { ?>
                        <form action="" method="POST">
                            <input class="input" type="hidden" name="pID" value="<?php echo isset($sucursal) ? $sucursal->id : '0'; ?>">
                            <input class="input" type="hidden" name="add" value="1">
                            <div class="field">
                                <label class="label">NOMBRE *</label>
                                <div class="control has-icons-left has-icons-right">
                                    <input class="input " type="text" placeholder="Ingresar nombre para el comercio" autofocus name="pNombre" required="" value="<?php echo isset($sucursal) ? $sucursal->nombre : ''; ?>">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left has-icons-right">
                                    <input class="input " type="text" placeholder="Ingresar telefono para el comercio" autofocus name="pTelefono" value="<?php echo isset($sucursal) ? $sucursal->telefono : ''; ?>">
                                    <span class="icon is-small is-left">
                                        ...
                                        <select required="" style="width:100%" id="sPaises" name="pPais">
                                            ...
                                            <?php if (isset($listaPaises) && count($listaPaises) >  0) { ?>
                                                ...
                                                <?php foreach ($listaPaises as $value) { ?>
                                                    <option value="<?php echo $value['idPais']; ?>" <?php echo (isset($sucursal) && isset($sucursal->idPais)) ? ($sucursal->idPais == $value['idPais']) ? 'selected' : ''  : ''; ?>>
                                        ...
                                        <select required="" style="width:100%" id="sDepartamentos" name="pDepartamento">
                                            <?php if (isset($listaDepartamentos) && count($listaDepartamentos) >  0) { ?>
                                                ...
                                                <?php foreach ($listaDepartamentos as $value) { ?>
                                                    <option value="<?php echo $value['idDepartamento']; ?>" <?php echo isset($sucursal) && isset($sucursal->idPais) ? $sucursal->idDepartamento == $value['idDepartamento'] ? 'selected' : ''  : ''; ?>>
                                                        <?php echo $value['nombre']; ?>
                                                    </option>
                                                <?php } ?>
                                            <?php } else { ?>
                                        ...
                                        <select required="" style="width:100%" id="sMunicipios" name="pMunicipio">
                                            <?php if (isset($listaMunicipios) && count($listaMunicipios) >  0) { ?>
                                                ...
                                                <?php foreach ($listaMunicipios as $value) { ?>
                                                    <option value="<?php echo $value['idMunicipio']; ?>" <?php echo isset($sucursal) && isset($sucursal->idPais) ? $sucursal->idMunicipio == $value['idMunicipio'] ? 'selected' : ''  : ''; ?>>
                                                        <?php echo $value['nombre']; ?>
                                                    </option>
                                                <?php } ?>
                                            <?php } else { ?>
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left has-icons-right">
                                    <input class="input " type="text" placeholder="Ingresar una direccion para el comercio" autofocus name="pDireccion" value="<?php echo isset($sucursal) ? $sucursal->direccion : ''; ?>">
                                    <span class="icon is-small is-left">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById("sPaises").onchange = function(evt) {
                ...
                if (idPais != '') {
                    fetch('/admin/servicios.php?idPais=' + idPais)
            ...
            document.getElementById("sDepartamentos").onchange = function(evt) {
                ...
                if (idDepartamento != '') {
                    fetch('/admin/servicios.php?idDepartamento=' + idDepartamento)
                        .then(response => response.json())
                        .then(data => {
