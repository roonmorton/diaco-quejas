...
if (isset($_POST)) {
    if (isset($_POST["del"]) && $_POST["del"] == "1") {
        ...
        $pais->id = $_POST["pID"];
        if ($pais->delete()) {
            echo '<script>alert("Pais eliminado Correctamente...");window.location.href = "/admin/regiones"; </script>';
        }
    } else {
        $pais = new Pais();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="buttons are-small">
                                                ...
                                                <a href="/admin/paises/regiones?pais=<?php echo $value['idPais']; ?>" class="button is-success is-outlined" title="Regiones">
                                                    <span class="icon is-small">
