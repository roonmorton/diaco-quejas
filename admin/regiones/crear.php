...
if (isset($_POST)) {
    if (isset($_POST["add"]) && $_POST["add"] == "1") {
        ...
        if ($region->add())
            echo '<script>alert("Region agregado Correctamente...");window.location.href = "/admin/regiones"; </script>';
        else
            $error = true;
            ...
            <div class="container" style="padding: 2.5em  0;">
                ...
                <div class="box" style="    padding-bottom: 2.5em; padding-top: 2.5em;">
                    <form action="" method="POST">
                        <input class="input" type="hidden" name="pID" value="<?php echo isset($region) ? $region->id : '0'; ?>" />
                        <input class="input" type="hidden" name="add" value="1" />
                        <div class="field">
                            <label class="label">NOMBRE *</label>
                            <div class="control has-icons-left has-icons-right">
                                <input class="input " type="text" placeholder="Ingresar nombre para la region" autofocus name="pNombre" required="" value="<?php echo isset($region) ? $region->nombre : ''; ?>" />
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left has-icons-right">
                                <input class="input " type="text" placeholder="Ingresar codigo unico como identificador para la región" name="pCode" required="" value="<?php echo isset($region) ? $region->code : ''; ?>" />
                                <span class="icon is-small is-left">
                        ...
                        <div class="field">
                            ...
                            <div class="control ">
                                <textarea class="textarea " type="number" placeholder="Ingresar una descripción" name="pDescripcion"><?php echo isset($region) ? $region->descripcion : ''; ?></textarea>
                            </div>
                        </div>
                        <br>
