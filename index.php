            ...
            <div class="box">
                    <table class="table is-striped is-hoverable is-fullwidth">
                        ...
                        <tbody>
                            ...
                            <?php $index = 1; foreach($sucursales as $value){ ?>
                            <tr>
                                <th>
                                    <?php echo $index; ?>
                                </th>
                                ...
                                <td>
                                    <div class="buttons are-small">
                                        <a href="/diaco-quejas/queja.php?sucursal=<?php echo $value['idSucursal']; ?>" class="button is-danger is-outlined" title="Registrar queja">
